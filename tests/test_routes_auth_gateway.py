...
def get_me(username: str="ddc.dev.python@gmail.com", password: str="password.for.debugging"):
...
def create_normal_user(new_user: CreateUser):
    ...
    new_user_dict = {
       "email" : "user_number_23@email.com",
       "password": "password",
       "phone_number": "8001234567",
       "is_superuser": True
    }

    response = requests.post(url, json=new_user_dict)
    if response.status_code == 200:
...
#print(get_all_users())
#print(update_user(2))
#print(get_me("user@email.com", "super.secret.password"9
#print(get_user(27))